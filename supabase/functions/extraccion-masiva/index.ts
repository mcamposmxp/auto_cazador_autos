...
const extraerUrlsDeListado = async (urlBusqueda: string, pagina: number): Promise<string[]> => {
...
const extraccionMasiva = async (
  termino: string = 'autos',
  maxPaginas: number = 5,
  maxAnunciosPorPagina: number = 10
): Promise<any> => {
