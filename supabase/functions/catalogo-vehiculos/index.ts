...
serve(async (req) => {
  ...
  try {
    ...
    const apiUrl = catalogId 
      ? `https://api.maxipublica.com/v3/catalog/mx/mxp/${catalogId}?requestSource=quote&hiddenData=otherCategories%2ColdYears&yearRange=true&oldeYears=hidden&origin=web`
      : `https://api.maxipublica.com/v3/catalog/mx/mxp/v_1?requestSource=quote&hiddenData=otherCategories%2ColdYears&yearRange=true&oldeYears=hidden&origin=web`;
