-- Crear edge function para aplicar autoajuste solo a autos con precio mínimo
-- Esta función se ejecutará periódicamente para aplicar las reglas de autoajuste
